# -*- coding: utf-8 -*-
# =========================================================
# 法拉第實驗（Exp6.xlsx）→ HTML 分析報告
# 功能：
# 1. 讀取 Exp6.xlsx（xlsx 本質是 zip 壓縮檔）
...
def main():
    ...
    plot_b = make_plotly_div(
        ...
        {
            "title": "實驗B：頻率 f 與感應電動勢 |εemf|",
            "xaxis": {"title": "頻率 f (kHz)"},
            "yaxis": {"title": "感應電動勢 |εemf| (mV)"},
        },
    )
